...
class ModelProviderService:
    ...
    def get_provider_list(self, tenant_id: str, model_type: Optional[str] = None) -> list[ProviderResponse]:
        ...
        #     raise Forbidden() 
        #newly added
        disabled_providers = ["cohere", "togetherai", "openrouter", "replicate", "zhipuai", "baichuan", "minimax", "tongyi", "wenxin", "chatglm", "volcengine_maas", "novita", "groq", "spark", "moonshot", "yi", "deepseek", "hunyuan", "siliconflow", "leptonai"]
