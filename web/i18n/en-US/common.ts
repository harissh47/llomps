const translation = {
  ...
  menus: {
    ...
    newApp: 'New App',
    newDataset: 'Create Data Mind', //Thinesh
    tools: 'Tools',
  },
  userProfile: {
    settings: 'Settings',
  ...
  account: {
    ...
    langGeniusAccount: 'Infinit Studio account',
    // langGeniusAccountTip: 'Your Dify account and associated user data.',
    langGeniusAccountTip: 'Your Infinit Studio account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Infinit Studio to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Infinit Studio allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  modelProvider: {
    ...
    // added newly
    // notConfigured: 'This feature available only for owners and admins',
  ...
  apiBasedExtension: {
    ...
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Infinit Studio\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Infinit Studio {{version}} is now available.',
    // latestAvailable: 'Dify {{version}} is the latest version available.',
    latestAvailable: 'Infinit Studio {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
