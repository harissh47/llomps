const translation = {
  list: {
    ...
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to Infinit Studio citations or indexed via the Chat plugin.',
    addFile: 'Add file',
    addPages: 'Add Pages',
    addUrl: 'Add URL',
    table: {
    ...
    empty: {
      ...
      sync: {
        ...
        tip: 'Infinit Studio will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
