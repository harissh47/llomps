const translation = {
  ...
  license: {
    ...
    tip: 'Before starting Infinit Studio Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  // joinTipEnd: 'team on Dify',
  joinTipEnd: 'team on Infinit Studio',
  invalid: 'The link has expired',
  // explore: 'Explore Dify',
  explore: 'Explore Infinit Studio',
