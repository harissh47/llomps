const translation = {
  ...
  feature: {
    ...
    conversationOpener: {
      ...
      description: 'In a chat application, the initial sentence spoken by the AI to the user is typically used as a greeting.',
    ...
    suggestedQuestionsAfterAnswer: {
      ...
      description: 'Providing suggested questions can enhance the user’s chat experience.',
    ...
    speechToText: {
      ...
      description: 'Once activated, you can utilize voice input.',
    ...
    textToSpeech: {
      ...
      description: 'Once activated, text can be transformed into speech.',
      resDes: 'Text to Audio is enabled',
    },
    citation: {
      title: 'Citations and Attributions',
      description: 'Once activated, the source document and the attributed section of the generated content will be displayed.',
    ...
    dataSet: {
      ...
      noData: 'You can import Data Mind as context',
      words: 'Words',
    ...
    moderation: {
      ...
      description: 'Ensure the security of model output by using a moderation API or by maintaining a list of sensitive words.',
  ...
  automatic: {
    ...
    description: 'Describe your scenario, Infinit Studio will orchestrate an application for you.',
  ...
  promptTip:
    'Prompts provide instructions and constraints for AI responses. Insert variables like {{input}}. The user will not be able to see this prompt.',
  ...
  variableTip:
    'When users fill out a form, variables are automatically replaced in the prompt.',
  ...
  notSetVar: 'Users can introduce prompt words or opening remarks when filling out forms using variables. Try entering "{{input}}" in the prompt.',
