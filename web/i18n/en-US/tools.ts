const translation = {
  title: 'Tools',
  createCustomTool: 'Create Custom App Fusion',
  // customToolTip: 'Learn more about Dify custom tools',
  customToolTip: 'Learn more about Infinit Studio custom tools',
  type: {
    all: 'All',
    builtIn: 'Built-in',
    custom: 'Custom',
  ...
  contribute: {
    ...
    line2: 'contributing tools to Infinit Studio.',
  ...
  createTool: {
    title: 'Create Custom App Fusion',
