  ...
  return (
    <>
      <div
        ...
        // className={`group flex flex-col bg-grey border-2 border-gray-200 border-solid rounded-xl shadow-sm h-[205px] transition-all duration-200 ease-in-out cursor-pointer hover:shadow-lg`}
        // className={`group flex flex-col bg-white border-2 border-gray-200 border-solid rounded-xl shadow-sm h-[205px] transition-all duration-200 ease-in-out cursor-pointer hover:shadow-lg`}
        className={`group flex flex-col bg-white border-2 border-gray-200 border-solid rounded-xl shadow-sm h-[205px] transition-all duration-200 ease-in-out cursor-pointer hover:shadow-lg ${getDarkThemeClasses('background4')} border-2 border-solid ${getDarkThemeClasses('border')} dark:rounded-xl dark:shadow-sm`}
      ...
      >
        ...
        <div className="flex bg-grey flex-col items-center pt-4 px-4">
          ...
          <div className={`text-base font-medium text-gray-800 text-center break-words max-w-full ${getDarkThemeClasses('text')}`} title={app.name}>
        ...
        <div
          className={cn(
            ...
            // tags.length ? 'line-clamp-2' : 'truncate'
            // className={cn(
            `flex-grow mb-2 px-6 text-xs leading-normal text-gray-500 pt-1 ${getDarkThemeClasses('sub_text2')}`,
            tags.length ? 'line-clamp-1' : 'truncate'
          )}
          // <div
          //   className={cn(
        ...
        <div className="flex px-4 justify-center opacity-0 group-hover:opacity-100 ">
          ...
          <TooltipPlus popupContent='Duplicate'>
            <div
              className={`px-2 py-1 opacity-50 hover:opacity-100 ${getDarkThemeClasses('text')} dark:white `}
              onClick={(e) => {
                e.stopPropagation();
                setShowDuplicateModal(true)
              }}
          ...
          <TooltipPlus popupContent='Export DSL'>
            <div
              className={`px-2 py-1 opacity-50 hover:opacity-100 ${getDarkThemeClasses('text')}`}
              onClick={(e) => {
                e.stopPropagation();
                onExport();
              }}
