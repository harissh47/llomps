...
import ActionsDefault from './nodes/actions/defaults'
...
export const NODES_EXTRA_DATA: Record<BlockEnum, NodesExtraData> = {
  ...
  [BlockEnum.Actions]: {
    ...
    availablePrevNodes: [],
    availableNextNodes: [],
    getAvailablePrevNodes: ActionsDefault.getAvailablePrevNodes,
    getAvailableNextNodes: ActionsDefault.getAvailableNextNodes,
    checkValid: ActionsDefault.checkValid,
  },
...
export const NODES_INITIAL_DATA = {
  ...
  [BlockEnum.Actions]: {
    type: BlockEnum.Actions,
    title: '',
    desc: '',
    query_variable_selector: [],
    topics: [],
    ...ActionsDefault.defaultValue,
  },
  [BlockEnum.HttpRequest]: {
...
export const SUPPORT_OUTPUT_VARS_NODE = [
  ...
  BlockEnum.ParameterExtractor, BlockEnum.Iteration, BlockEnum.Actions,
]
...
export const ACTIONS_OUTPUT_STRUCT = [
  {
    variable: 'class_name',
    type: VarType.string,
  },
