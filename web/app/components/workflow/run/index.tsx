  ...
  return (
    <div className='grow relative flex flex-col'>
      ...
      <div className='shrink-0 flex items-center px-4 border-b-[0.5px] border-[rgba(0,0,0,0.05)]'>
        ...
        <div
          className={cn(
            'mr-6 py-3 border-b-2 border-transparent text-[13px] font-semibold leading-[18px] text-gray-400 dark:text-[#6B7082] cursor-pointer',
            currentTab === 'DETAIL' && '!border-[rgb(21,94,239)] text-gray-700 dark:text-[#A1A6B2]',
          )}
        ...
        <div
          className={cn(
            'mr-6 py-3 border-b-2 border-transparent text-[13px] font-semibold leading-[18px] text-gray-400 dark:text-[#6B7082] cursor-pointer',
            currentTab === 'TRACING' && '!border-[rgb(21,94,239)] text-gray-700 dark:text-[#A1A6B2]',
          )}
      ...
      <div ref={ref} className={cn('grow bg-white dark:bg-[#333333] h-0 overflow-y-auto rounded-b-2xl', currentTab !== 'DETAIL' && '!bg-gray-50 dark:!bg-[#383838]')}>
        {loading && (
