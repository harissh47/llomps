...
const ChatRecord = () => {
  ...
  return (
    <div
      ...
      // `}
      className={`
        flex flex-col w-[400px] rounded-l-2xl h-full border border-black/2 shadow-xl dark:border-[#5F5F5F] overflow-hidden
      `}
      style={{
    ...
    >
      ...
      {fetched && (
        <>
          ...
          <div className='shrink-0 flex items-center justify-between p-4 pb-1 text-base font-semibold text-gray-900 dark:bg-[#383838] dark:text-white'>
