  ...
  return (
    ...
    >
      ...
      <PortalToFollowElemContent>
        ...
        <div className={`min-w-[192px] bg-white ${getDarkThemeClasses('background3')} rounded-md border-[0.5px] border-gray-200 ${getDarkThemeClasses('border')} shadow-xl`}>
          <div className='p-1'>
            <div
              // className='flex items-center justify-between px-3 h-8 cursor-pointer rounded-md text-sm text-gray-700 hover:bg-black/5'
               className={`flex items-center justify-between px-3 h-8 cursor-pointer rounded-md text-sm text-gray-700 ${getDarkThemeClasses('text')} hover:bg-black/5`}
              onClick={() => {
                onCopy()
                setOpen(false)
              }}
          ...
          <div className='p-1'>
            <div
              ...
              className={`flex items-center justify-between px-3 h-8 cursor-pointer rounded-md text-sm text-gray-700 ${getDarkThemeClasses('text')} hover:text-[#D92D20] hover:bg-[#FEF3F2] ${getDarkThemeClasses('hover')}`}
