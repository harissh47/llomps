...
const VarList: FC<Props> = ({
  ...
  if (list.length === 0) {
    return (
      // <div className='flex rounded-md bg-gray-50 dark:bg-[#3F3F3F] items-center h-[42px] justify-center leading-[18px] text-xs font-normal text-gray-500'>
        <div className='flex rounded-md bg-gray-50 dark:bg-[#2C2C2C] items-center h-[42px] justify-center leading-[18px] text-xs font-normal text-gray-500 dark:text-[#FCFCFC]'>
