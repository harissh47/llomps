      ...
      <div className='px-4 pb-4 space-y-4'>
        ...
        {isChatMode && isChatModel && !!inputs.memory && (
          <div className='mt-4'>
            ...
            <div className='flex justify-between items-center h-8 pl-3 pr-2 rounded-lg bg-gray-100 dark:bg-[#2c2c2c]'>
              <div className='flex items-center space-x-1'>
                {/* <div className='text-xs font-semibold text-gray-700 uppercase'>{t('workflow.nodes.common.memories.title')}</div> */}
                <div className='text-xs font-semibold text-gray-700 dark:text-white uppercase'>{t('workflow.nodes.common.memories.title')}</div>
                <TooltipPlus
              ...
              <div className='flex items-center h-[18px] px-1 rounded-[5px] border border-black/8 dark:border-[#5F5F5F] text-xs font-semibold text-gray-500 dark:text-white uppercase'>{t('workflow.nodes.common.memories.builtIn')}</div>
            </div>
            {/* Readonly User Query */}
            <div className='mt-4'>
              <Editor
                title={<div className='flex items-center space-x-1'>
                  ...
                  <div className='text-xs font-semibold text-gray-700 dark:text-white uppercase'>user</div>
                  <TooltipPlus
                    popupContent={
