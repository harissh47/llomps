...
const Node: FC<NodeProps<HttpNodeType>> = ({
  ...
  return (
    <div className='mb-1 px-3 py-1'>
      ...
      <div className='flex items-start p-1 rounded-md bg-gray-100 dark:bg-[#3f3f3f]'>
        ...
        <div className='flex items-center h-4 shrink-0 px-1 rounded bg-gray-25 dark:bg-[#5f5f5f] text-xs font-semibold text-gray-700 dark:text-white uppercase'>{method}</div>
