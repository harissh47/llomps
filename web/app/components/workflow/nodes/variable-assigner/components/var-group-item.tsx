    ...
    <Field
      ...
      title={groupEnabled
        ? <div className='flex items-center'>
          <div className='flex items-center !normal-case'>
            ...
            {(!isEditGroupName)
              ? (
                ...
                <div className='flex items-center h-6 px-1 rounded-lg cursor-text hover:bg-gray-100 dark:hover:bg-zinc-800' onClick={setEditGroupName}>
                  {payload.group_name}
                </div>
              )
              : (
                <input
                  ...
                  className='h-6 px-1 rounded-lg bg-white dark:bg-[#333333] border border-gray-300 dark:border-[#5F5F5F] focus:outline-none'
                  // style={{
          ...
          {canRemove && (
            <div
              className='group-hover:block dark:group-hover:bg-zinc-800 hidden ml-0.5 p-1 rounded-md text-gray-500 cursor-pointer hover:bg-[#FEE4E2] hover:text-[#D92D20]'
              onClick={onRemove}
            >
              <Trash03
                className='w-4 h-4'
