  ...
  return (
    ...
    >
      <div className='flex items-center justify-between h-4 text-[10px] font-medium text-gray-500'>
        <span
          className={cn(
            'grow uppercase truncate dark:text-[#A1A6B2]',
        ...
        <div className='flex items-center'>
          <span className='shrink-0 ml-2 dark:text-[#A1A6B2]'>{item.type}</span>
      ...
      </div>
      {
        !item.variables.length && (
          <div
            className={cn(
              'relative flex items-center px-1 h-[22px] justify-between bg-gray-100 dark:bg-[#3F3F3F] rounded-md space-x-1 text-[10px] font-normal text-gray-400 dark:text-[#FCFCFC] uppercase',
