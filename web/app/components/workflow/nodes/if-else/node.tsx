  ...
  return (
    <div className='px-3'>
      <div className='relative flex items-center h-6 px-1'>
        ...
        <div className='w-full text-xs font-semibold text-right text-gray-700 dark:text-[#A1A6B2]'>IF</div>
        <NodeSourceHandle
          {...props}
          handleId='true'
          ...
          <div key={condition.id} className='relative'>
            {(condition.variable_selector?.length > 0 && condition.comparison_operator && (isEmptyRelatedOperator(condition.comparison_operator!) ? true : !!condition.value))
              ? (
                ...
                <div className='flex items-center h-6 px-1 space-x-1 text-xs font-normal text-gray-700 dark:text-[#FCFCFC] bg-gray-100 dark:bg-[#3F3F3F] rounded-md'>
                  ...
                  <span className='text-gray-500 dark:text-[#A1A2B6]'>{isComparisonOperatorNeedTranslate(condition.comparison_operator) ? t(`${i18nPrefix}.comparisonOperator.${condition.comparison_operator}`) : condition.comparison_operator}</span>
              ...
              : (
                ...
                <div className='flex items-center h-6 px-1 space-x-1 text-xs font-normal text-gray-500 dark:text-[#FCFCFC] bg-gray-100 dark:bg-[#3F3F3F] rounded-md'>
      ...
      <div className='relative flex items-center h-6 px-1'>
        ...
        <div className='w-full text-xs font-semibold text-right text-gray-700 dark:text-[#A1A6B2]'>ELSE</div>
        <NodeSourceHandle
          {...props}
          handleId='false'
          handleClassName='!top-1/2 !-right-[21px] !-translate-y-1/2'
