...
const Item: FC<ItemProps> = ({
  ...
  return (
    <div
      ...
      className={cn(isChosen ? 'border-[1.5px] border-primary-400 bg-white dark:bg-[#3f3f3f]' : 'border border-gray-100 dark:border-[#5f5f5f] bg-gray-25 dark:bg-[#3f3f3f]', 'grow w-0 shrink-0 flex items-center h-8 justify-center rounded-lg cursor-pointer text-[13px] font-normal text-gray-900 dark:text-white')}
