...
const CodeEditor: FC<Props> = ({
  ...
  const handleEditorDidMount = (editor: any, monaco: any) => {
    ...
    const getEditorBackground = () => (isDarkTheme ? "#3f3f3f" : "#f2f4f7");
    ...
    monaco.editor.defineTheme("default-theme", {
      ...
      rules: [],
      colors: {
        "editor.background": getEditorBackground(),
      },
    });
    ...
    monaco.editor.defineTheme("focus-theme", {
      ...
      rules: [],
      colors: {
        "editor.background": isDarkTheme ? "#3f3f3f" : "#ffffff",
      },
    });
    ...
    editor.onDidFocusEditorText(() => {
      monaco.editor.setTheme("focus-theme");
      setIsFocus(true);
    });
    editor.onDidBlurEditorText(() => {
      monaco.editor.setTheme("blur-theme");
      setIsFocus(false);
    });
