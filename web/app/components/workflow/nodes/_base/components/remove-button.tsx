...
const Remove: FC<Props> = ({
  ...
  return (
    <div
      ...
      className={cn(className, 'p-1 cursor-pointer rounded-md dark:bg-[#2c2c2c] hover:bg-black/5 dark:hover:bg-zinc-800 text-gray-500 dark:!bg-[#2c2c2c] hover:text-gray-500')}
      onClick={onClick}
    >
