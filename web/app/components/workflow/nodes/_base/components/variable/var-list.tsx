        ...
        <div className='flex items-center space-x-1' key={index}>
          ...
          {!readonly && (
            <RemoveButton
              ...
              className={`!p-2 !bg-gray-100 ${getDarkThemeClasses('background2')} hover:!bg-gray-200 ${getDarkThemeClasses('hover')}`}
