      ...
      {list.map((item, index) => (
        <div className='flex items-center space-x-1' key={index}>
          <input
            ...
            className='w-[120px] h-8 leading-8 px-2.5 rounded-lg border-0 bg-gray-100 dark:!bg-[#2c2c2c]  text-gray-900 dark:text-white text-[13px]  placeholder:text-gray-400 dark:placeholder:text-white focus:outline-none focus:ring-1 focus:ring-inset focus:ring-gray-200 dark:focus:ring-[#5f5f5f]'
          ...
          {!readonly && (
            <RemoveButton
              ...
              className='!p-2 !bg-gray-100 dark!bg-[#3f3f3f] hover:!bg-gray-200 dark:hover:!bg-zinc-800'
