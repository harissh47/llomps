...
export const AddVariablePopup = ({
  ...
  return (
    ...
    <div className={`w-[240px] bg-white border-[0.5px] border-gray-200 ${getDarkThemeClasses('background3')} ${getDarkThemeClasses('border')} rounded-lg shadow-lg`}>
      {/* <div className='flex items-center px-4 h-[34px] text-[13px] font-semibold text-gray-700 border-b-[0.5px] border-b-gray-200'> */}
      <div className={`flex items-center px-4 h-[34px] text-[13px] font-semibold text-gray-700 ${getDarkThemeClasses('sub_text1')} border-b-[0.5px] border-b-gray-200 ${getDarkThemeClasses('border')}`}>
