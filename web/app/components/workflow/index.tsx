...
const Workflow: FC<WorkflowProps> = memo(
  ({ nodes: originalNodes, edges: originalEdges, viewport }) => {
    ...
    const { setShowConfirm, setControlPromptEditorRerenderKey } =
...
const WorkflowWrap = memo(() => {
  ...
  const initialFeatures: FeaturesData = {
    ...
    opening: {
      ...
      show_carousel: features.show_carousel,
      show_openingcontainer: features.show_openingcontainer,
      carousel_images: features.carousel_images,
    },
