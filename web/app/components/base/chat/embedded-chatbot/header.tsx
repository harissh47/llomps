...
const Header: FC<IHeaderProps> = ({
  ...
  //   <div
  //     className={`
  //       shrink-0 flex items-center justify-between h-14 px-4 bg-[#bed730] fixed top-0 right-0 left-0 z-10
  //     `}
  //   >
  ...
  return (
    <div
      ...
      // `}
      className={`
        shrink-0 flex items-center justify-between h-14 px-4 bg-[#bed730]
      `}
    >
      <div className="flex items-center space-x-2">
        {customerIcon}
