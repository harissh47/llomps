  ...
  return (
    <div className='flex justify-end mb-2 last:mb-0 pl-10'>
      <div className='group relative mr-4'>
        ...
        {/* <div className='px-4 py-3 bg-[#D1E9FF]/80 rounded-b-2xl rounded-tl-2xl text-sm text-gray-900'> */}
        <div className='px-4 py-3.5 pl-5 bg-[#bed730] rounded-l-3xl rounded-br-3xl rounded-tr-md text-sm text-gray-900'>
          {
            !!imgSrcs.length && (
