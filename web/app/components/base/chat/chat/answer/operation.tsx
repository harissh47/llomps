    ...
    <>
      ...
      >
        ...
        {!isOpeningStatement && (showPromptLog || config?.text_to_speech?.enabled) && (
          ...
          <div className='hidden group-hover:flex items-center w-max h-[28px] p-0.5 rounded-lg bg-white dark:bg-[#383838] border-[0.5px] border-gray-100 dark:border-[#383838] shadow-md shrink-0'>
            {showPromptLog && (
              <Log logItem={item} />
            )}
        ...
        )}
        {
          !positionRight && annotation?.id && (
            <div
              className='relative box-border flex items-center justify-center h-7 w-7 p-0.5 rounded-lg bg-white cursor-pointer text-[#8AB40A] shadow-md group-hover:hidden'
            >
