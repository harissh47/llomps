  ...
  const Item = (
    <div
      className={cn(
        ...
        isSelected ? ' border-[#84ADFF] dark:border-[#333333] bg-[#F5F8FF] dark:bg-[#5F5F5F]' : ' border-black/5 bg-white dark:bg-[#5F5F5F]',
        // !node && '!border-[#F04438] !bg-[#FEF3F2]',
        !node && '!border-[#F04438] !bg-[#FEF3F2] dark:!bg-[#5F5F5F]',
      )}
      ref={ref}
    >
      <div className='flex items-center'>
        ...
        <div className='shrink-0 mx-0.5 text-xs font-medium text-gray-500 dark:text-[#A1A6B2] truncate' title={node?.title} style={{
        }}>{node?.title}</div>
