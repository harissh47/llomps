...
const RetryButton: FC<Props> = ({ datasetId }) => {
  ...
  return (
    ...
    <div className={classNames('inline-flex justify-center items-center gap-2 h-9 leading-5 rounded-lg px-4 py-2 text-base border-solid border border-gray-200 text-gray-500 hover:bg-white dark:hover:bg-zinc-800 hover:shadow-sm hover:border-gray-300')}>
      <WarningIcon />
