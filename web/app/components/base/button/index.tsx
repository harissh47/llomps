...
const Button: FC<IButtonProps> = ({
  ...
  //   typeClassNames,
  //   className,
  //   'dark:border-2 dark:border-[#3f3f3f] dark:border-solid dark:rounded-xl dark:shadow-sm dark:hover:bg-[#C6E473] cursor-pointer dark:!text-[#FCFCFC]'
  // )}
  className={classNames(
    'btn',
    typeClassNames,
    className,
    ' dark:rounded-xl dark:shadow-sm dark:hover:bg-[#C6E473] cursor-pointer dark:!text-[#FCFCFC]'
  )}
  tabIndex={tabIndex}
  onClick={disabled ? undefined : onClick}
>
