...
const MessageLogModal: FC<MessageLogModalProps> = ({
  ...
  return (
    <div
      ...
      className={cn('relative flex flex-col py-3 bg-white dark:bg-[#333333] border-[0.5px] border-gray-200 dark:border-[#5F5F5F] rounded-xl shadow-xl z-10')}
      style={{
      ...
      {isShowIterationDetail
        ...
        : (
          <>
            ...
            <h1 className='shrink-0 px-4 py-1 text-md font-semibold text-gray-900 dark:text-white'>{t('appLog.runDetail.title')}</h1>
