...
<<<<<<< HEAD
    <div className="w-[420px] max-w-full rounded-lg p-7 bg-white dark:bg-[#3e3e3e]">
=======
    // <div className="w-[420px] max-w-full rounded-lg p-7 bg-white dark:bg-[#3e3e3e]">
    <div className={`w-[420px] max-w-full rounded-lg p-7 ${getDarkThemeClasses('text')} ${getDarkThemeClasses('background1')}`}>
>>>>>>> origin/rupa
...
<<<<<<< HEAD
        <div className='ml-4 text-lg text-gray-900 dark:text-white'>{title}</div>
      </div>

      <div className='mt-1 ml-12'>
        {/* <div className='text-sm leading-normal text-gray-500'>{content}</div> */}
        <div className='text-sm leading-normal text-gray-500 dark:text-[#A1A2B6]'>{content}</div>
      </div>
      ...
      <div className='flex gap-3 mt-4 ml-12'>
        ...
        <Button onClick={onCancel} className='flex items-center justify-center min-w-20 text-center text-gray-500 border rounded-lg cursor-pointer h-9 border-color-gray-200 dark:bg-[#3e3e3e] dark:border-[#5F5F5F] dark:hover:bg-zinc-800'>{cancelText || t('common.operation.cancel')}</Button>
...
=======
        {/* <div className='ml-4 text-lg text-gray-900 dark:text-white'>{title}</div> */}
        <div className={`ml-4 text-lg text-gray-900 ${getDarkThemeClasses('text')}`}>{title}</div>
      </div>
 
      <div className='mt-1 ml-12'>
        {/* <div className='text-sm leading-normal text-gray-500'>{content}</div> */}
        {/* <div className='text-sm leading-normal text-gray-500 dark:text-[#A1A2B6]'>{content}</div> */}
        <div className={`text-sm leading-normal text-gray-500 ${getDarkThemeClasses('sub_text3')}`}>{content}</div>
      </div>
 
      <div className='flex gap-3 mt-4 ml-12'>
        {/* <Button type='primary' onClick={onConfirm} className='flex items-center justify-center min-w-20 text-center text-white rounded-lg cursor-pointer h-9 '>{confirmText || t('common.operation.confirm')}</Button> */}
        <Button type='primary' onClick={onConfirm} className={`flex items-center justify-center min-w-20 text-center ${getDarkThemeClasses('text')}  rounded-lg cursor-pointer h-9 `}>{confirmText || t('common.operation.confirm')}</Button>
 
        {/* <Button onClick={onCancel} className='flex items-center justify-center min-w-20 text-center text-gray-500 border rounded-lg cursor-pointer h-9 border-color-gray-200'>{cancelText || t('common.operation.cancel')}</Button> */}
        {/* <Button onClick={onCancel} className='flex items-center justify-center min-w-20 text-center text-gray-500 border rounded-lg cursor-pointer h-9 border-color-gray-200 dark:bg-[#3e3e3e] dark:border-[#5F5F5F] dark:hover:bg-zinc-800'>{cancelText || t('common.operation.cancel')}</Button> */}
        <Button onClick={onCancel} className={`flex items-center justify-center min-w-20 text-center text-gray-500 border rounded-lg cursor-pointer h-9 border-color-gray-200 ${getDarkThemeClasses('background1')} ${getDarkThemeClasses('border')} ${getDarkThemeClasses('hover')} `}>{cancelText || t('common.operation.cancel')}</Button>
