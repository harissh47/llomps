    ...
    >
      <PortalToFollowElemTrigger onClick={handleToggle}>
        <button
          type="button"
          disabled={disabled}
          className="relative flex items-center justify-center w-8 h-8 enabled:hover:bg-gray-100 dark:enabled:hover:bg-zinc-800 rounded-lg disabled:cursor-not-allowed"
        >
          <ImagePlus className="w-4 h-4 text-gray-500" />
        </button>
      </PortalToFollowElemTrigger>
                ...
                {hovering => (
                  <div
                    className={cn(
                      ...
                      'flex items-center justify-center h-8 text-[13px] font-medium text-[#8AB40A] rounded-lg cursor-pointer',
