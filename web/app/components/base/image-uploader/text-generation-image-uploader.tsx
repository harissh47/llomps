  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={handleToggle}>
        <div className={`
          relative flex items-center justify-center px-3 h-8 bg-gray-100 ${getDarkThemeClasses('background2')} hover:bg-gray-200 text-xs text-gray-500 rounded-lg
    ...
    >
      {
        hovering => (
          <div className={`
            flex items-center justify-center px-3 h-8 bg-gray-100 ${getDarkThemeClasses('background2')} ${getDarkThemeClasses('hover')}
