...
export const SegmentIndexTag: FC<{ positionId: string | number; className?: string }> = ({ positionId, className }) => {
  ...
  return (
    <div className={`text-gray-500 dark:text-white border border-gray-200 dark:border-[#5f5f5f] box-border flex items-center rounded-md italic text-[11px] pl-1 pr-1.5 font-medium ${className ?? ''}`}>
