...
const EmbeddingDetail: FC<Props> = ({ detail, stopPosition = 'top', datasetId: dstId, documentId: docId, indexingType, detailUpdate }) => {
  ...
  const navToDocument = () => {
    ...
    router.push(`/data-mind/${localDatasetId}/documents/${localDocumentId}`)
  }
  ...
  return (
    <>
      ...
      <div className="w-full flex justify-between items-center text-xs text-gray-700 dark:text-[#a1a6b2]">
        ...
        {localIndexingTechnique === 'economy' && (
          <div className='flex items-center dark:text-[#a1a6b2]'>
      ...
      {onTop && <>
        ...
        <div className="pb-1 pt-4 text-gray-900 dark:text-white text-sm font-medium">
