        ...
        {docForm === DocForm.TEXT && (
          <table className='table-fixed w-full border-separate border-spacing-0 border border-gray-200 dark:border-[#5f5f5f] rounded-lg text-xs'>
            <thead className='text-gray-500 dark:text-white'>
              <tr>
                <td className='h-9 pl-3 pr-2 border-b border-gray-200 dark:border-[#5f5f5f]'>{t('datasetDocuments.list.batchModal.contentTitle')}</td>
              </tr>
            </thead>
            <tbody className='text-gray-700'>
              <tr>
                <td className='h-9 pl-3 pr-2 border-b border-gray-100 dark:border-[#5f5f5f] text-[13px] dark:text-[#a1a6b2]'>{t('datasetDocuments.list.batchModal.content')} 1</td>
              </tr>
              <tr>
                <td className='h-9 pl-3 pr-2 text-[13px] dark:text-[#a1a6b2]'>{t('datasetDocuments.list.batchModal.content')} 2</td>
              </tr>
            </tbody>
          </table>
        )}
