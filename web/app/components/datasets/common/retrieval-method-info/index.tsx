        ...
        chosenConfig={
          <div className='flex flex-wrap leading-[18px] text-xs font-normal'>
            ...
            <div className='mr-8 flex space-x-1'>
              ...
              <div className='text-gray-500 dark:text-[#A1A6B2]'>{t('appDebug.datasetConfig.top_k')}</div>
              {/* <div className='font-medium text-gray-800'>{value.top_k}</div> */}
              <div className='font-medium text-gray-800 dark:text-[#FCFCFC]'>{value.top_k}</div>
            </div>

            <div className='mr-8 flex space-x-1'>
              {/* <div className='text-gray-500'>{t('appDebug.datasetConfig.score_threshold')}</div> */}
              <div className='text-gray-500 dark:text-[#A1A6B2]'>{t('appDebug.datasetConfig.score_threshold')}</div>
