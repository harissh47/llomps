        ...
        <RadioCard
          ...
          title={
            <div className='flex items-center space-x-1'>
              ...
              <div className='flex h-full items-center px-1.5 rounded-md border border-[#E0EAFF] text-xs font-medium text-[#8AB40A]'>{t('dataset.retrieval.hybrid_search.recommend')}</div>
            </div>
          }
