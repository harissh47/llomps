    ...
    <>
      <div className='h-5 flex justify-between items-center mb-5'>
        ...
        <div className={s.cost}>
          ...
          {indexingType === 'economy' && (
            <div className='flex items-center dark:text-[#FCFCFC]'>
              ...
              <div className="w-3 h-3 mr-1 inline-block align-middle bg-[#8AB40A] mask bg-no-repeat" style={{ maskImage: 'url(../assets/normal1.svg)' }} />
              {t('datasetDocuments.embedding.economy')} · {t('datasetDocuments.embedding.estimate')}
              <span className="text-xs font-medium px-1 dark:text-[#FCFCFC]">0</span> tokens
            </div>
          )}
        </div>
      </div>
      {
        enableBilling && plan.type !== Plan.team && (
          ...
          <div className='flex items-center mb-3 p-3 h-14 bg-white dark:bg-[#3F3F3F] border-[0.5px] border-black/5 dark:border-[#5F5F5F] shadow-md rounded-xl'>
            ...
            <div className='grow mx-3 text-[13px] font-medium text-gray-700 dark:text-white'>
      ...
      <div className={s.progressContainer}>
        {indexingStatusBatchDetail.map(indexingStatusDetail => (
          <div key={indexingStatusDetail.id} 
          className={cn(
            s.sourceItem,
            ...
            {isSourceEmbedding(indexingStatusDetail) && (
              ...
              <div
              className="absolute top-0 left-0 h-full bg-[#B2CCFF]"
