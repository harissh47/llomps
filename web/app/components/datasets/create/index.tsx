...
const DatasetUpdateForm = ({ datasetId }: DatasetUpdateFormProps) => {
  ...
  return (
    ...
    <div className='flex w-full'>
      ...
      <div className={`flex flex-col w-11 sm:w-56 overflow-y-auto bg-white ${getDarkThemeClasses('main_background')}  border-r border-gray-200 ${getDarkThemeClasses('border')}  shrink-0`}>
