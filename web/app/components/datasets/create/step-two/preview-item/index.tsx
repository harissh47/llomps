...
const PreviewItem: FC<IPreviewItemProps> = ({
  ...
  return (
    ...
    <div className='p-4 rounded-xl bg-gray-50 dark:bg-[#3F3F3F]'>
      <div className='flex items-center justify-between h-5 text-xs text-gray-500'>
        ...
        <div className='flex items-center h-[18px] space-x-1 border border-gray-200 dark:border-[#5F5F5F] box-border rounded-md italic pl-1 pr-1.5 font-medium'>
          {sharpIcon}
          <span>{formatedIndex}</span>
        </div>
        <div className='flex items-center space-x-1 dark:text-[#A1A6B2]'>
          {textIcon}
      ...
      <div className='mt-2 max-h-[120px] line-clamp-6 overflow-hidden text-sm text-gray-800 dark:text-[#FCFCFC]'>
        {type === PreviewType.TEXT && (
