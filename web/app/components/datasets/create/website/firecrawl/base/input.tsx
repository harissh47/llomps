...
const Input: FC<Props> = ({
  ...
  return (
    <input
      ...
      className='flex h-9 w-full py-1 px-2 rounded-lg text-xs leading-normal bg-gray-100 dark:bg-[#3F3F3F] caret-primary-600 hover:bg-gray-100 focus:ring-1 focus:ring-inset focus:ring-gray-200 dark:focus:ring-[#5f5f5f] focus-visible:outline-none focus:bg-gray-50 dark:focus:bg-zinc-800 placeholder:text-gray-400 dark:text-[#FCFCFC]'
