...
const RecordsEmpty: FC = () => {
  ...
  return <div className='bg-gray-50 dark:bg-[#3F3F3F] rounded-2xl p-5'>
{/* <div className={s.clockWrapper}> */}
<div className="border border-[#eaecf5] dark:border-[#5f5f5f] rounded-lg w-11 h-11 flex justify-center items-center">
      ...
      <div className="border-r border-gray-100 dark:border-[#5f5f5f] px-6 py-3 flex flex-col">
        ...
        <div className='flex justify-start items-center mb-4'>
          ...
          <div className='flex flex-col'>
            ...
            <h1 className="text-xl font-medium text-gray-900 dark:text-white">{t('datasetHitTesting.title')}</h1>
            <p className="text-sm font-normal text-gray-500 dark:text-[#FCFCFC]">{t('datasetHitTesting.desc')}</p>
          </div>
        </div>
        <Textarea
          datasetId={datasetId}
        ...
        <div className="text-xl font-medium text-gray-900 dark:text-white mt-8 mb-2">
            ...
            : !hitResult?.records.length
              ? (
                <div className='h-full flex flex-col justify-center items-center'>
                  <div className={cn(docStyle.commonIcon, docStyle.targetIcon, '!bg-gray-200 dark:!bg-[#3f3f3f] !h-14 !w-14')} />
