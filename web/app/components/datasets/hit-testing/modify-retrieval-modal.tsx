...
const ModifyRetrievalModal: FC<Props> = ({
  ...
  return (
    <div
      ...
      className='w-full flex flex-col bg-white dark:bg-[#333333] border-[0.5px] border-gray-200 dark:border-[#5f5f5f] rounded-xl shadow-xl'
      style={{
    ...
    >
      ...
      >
        <Button className='mr-2 flex-shrink-0 dark:border-0 dark:bg-[#3f3f3f] dark:hover:bg-zinc-800' onClick={onHide}>{t('common.operation.cancel')}</Button>
