...
// `
const inputClass = `
  w-full max-w-[480px] px-3 bg-gray-100 dark:bg-[#3f3f3f] text-sm text-gray-800 dark:text-white rounded-lg outline-none appearance-none
`
...
const Form = () => {
  ...
  return (
    ...
    <div className='w-full sm:w-[800px] p-4 sm:px-16 sm:py-6 dark:text-white'>
      ...
      {currentDataset && currentDataset.indexing_technique && (
        <>
          ...
          <div className='w-full h-0 border-b-[0.5px] border-b-gray-200 dark:border-b-[#5f5f5f] my-2' />
      ...
      {currentDataset?.embedding_available && (
        <div className={rowClass}>
          ...
          <div className='w-[480px]'>
            <Button
              className='min-w-24 text-sm mb-8'
              type='primary'
              onClick={handleSave}
            >
