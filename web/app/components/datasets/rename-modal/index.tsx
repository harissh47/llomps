...
const RenameDatasetModal = ({ show, dataset, onSuccess, onClose }: RenameDatasetModalProps) => {
  ...
  return (
    ...
    >
      ...
      <div className='relative pb-2 text-xl font-medium leading-[30px] text-gray-900 dark:text-white'>{t('datasetSettings.title')}</div>
      ...
      <div>
        <div className={cn('flex justify-between py-4 flex-wrap items-center')}>
          ...
          <div className='shrink-0 py-2 text-sm font-medium leading-[20px] text-gray-900 dark:text-white'>
        ...
        <div className={cn('flex justify-between py-4 flex-wrap items-center')}>
          ...
          <div className='w-full'>
            <textarea
              ...
              className='block px-3 py-2 w-full h-[88px] rounded-lg bg-gray-100 dark:bg-[#3F3F3F] dark:text-[#FCFCFC] text-sm outline-none appearance-none resize-none'
      ...
      <div className='pt-6 flex justify-end'>
        ...
        <Button className='mr-2 text-gray-700 text-sm font-medium dark:bg-[#333333] dark:border-[#5F5F5F] dark:hover:bg-zinc-800' onClick={onClose}>{t('common.operation.cancel')}</Button>
