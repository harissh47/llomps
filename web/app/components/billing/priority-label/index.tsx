  ...
  return (
    <TooltipPlus popupContent={
      <div>
        ...
        <div className='mb-1 text-xs font-semibold text-gray-700 dark:text-[#FCFCFC]'>{`${t('billing.plansCommon.documentProcessingPriority')}: ${t(`billing.plansCommon.priority.${priority}`)}`}</div>
        {
