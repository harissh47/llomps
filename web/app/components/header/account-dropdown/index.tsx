...
export default function AppSelector({ isMobile }: IAppSelecotr) {
  ...
  const AccountButtons = () => (
    <div className='w-full'>
      <div className={itemClassName} onClick={handleSettingsRoute}>
  ...
  const UserProfile = () => (
    <div className='w-full px-2.5 flex flex-nowrap items-center py-[13px]'>
  ...
  return { AccountButtons, UserProfile }
}
// 'use client'
// import { useTranslation } from 'react-i18next'
// import { Fragment, useState } from 'react'
...
//         </div>
//       </div>
//       {/* <div className='px-2.5 flex flex-nowrap items-center py-[13px]'> */}
//       <div className='mt-4 px-2.5 flex flex-nowrap items-center py-[13px] border-t border-gray-200'>
//         {/* <Avatar name={userProfile.name} size={36} className='mr-3' /> */}
//         <Avatar name={userProfile.name} size={32} className='mr-2' />
//         <div className='grow'>
