  ...
  return (
    <>
      <div className='flex flex-col'>
        ...
        <div className='flex items-center mb-4 p-3 bg-gray-50 dark:bg-[#3F3F3F] rounded-2xl'>
          ...
          <div className={
            ...
            text-[13px] font-medium text-primary-600 bg-white dark:bg-[#5F5F5F]
        ...
        <div className='overflow-visible lg:overflow-visible'>
          <div className='flex items-center py-[7px] border-b dark:border-b-[#5f5f5f] border-gray-200 min-w-[480px]'>
