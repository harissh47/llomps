  ...
  return (
    <div className={cn(s.wrap)}>
      <Modal overflowVisible isShow onClose={() => {}} className={cn(s.modal)} wrapperClassName='z-20'>
        ...
        <div className='mb-7 text-[13px] text-gray-500 dark:text-[#FCFCFC]'>{t('common.members.inviteTeamMemberTip')}</div>
        <div>
          ...
          <div className='mb-8 h-36 flex items-stretch'>
            <ReactMultiEmail
              // className={cn('w-full pt-2 px-3 outline-none border-none  dark:!bg-[#3F3F3F]',
              //   'appearance-none text-sm text-gray-900 dark:text-white rounded-lg overflow-y-auto ',
              //   s.emailsInput,
              // )}
              className={cn('w-full pt-2 px-3 outline-none border focus-within:dark:border-[#5f5f5f] dark:!bg-[#3F3F3F]',
                'appearance-none text-sm text-gray-900 dark:text-white rounded-lg overflow-y-auto ',
                s.emailsInput,
              )}
              autoFocus
          ...
          <Listbox value={role} onChange={setRole}>
            <div className="relative pb-6">
              ...
              <Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-gray-100 dark:bg-[#3F3F3F] outline-none border-none appearance-none text-sm text-gray-900 dark:text-white rounded-lg">
