...
const Empty = () => {
  ...
  return (
    ...
    <div className='mb-2 p-6 rounded-2xl bg-gray-50 dark:bg-[#3F3F3F]'>
      <div className='flex items-center justify-center mb-3 w-12 h-12 rounded-[10px] border border-[#EAECF5] dark:border-[#5f5f5f]'>
        <Webhooks className='w-6 h-6 text-gray-500' />
      </div>
      {/* <div className='mb-2 text-sm text-gray-600'>{t('common.apiBasedExtension.title')}</div> */}
      <div className='mb-2 text-sm text-gray-600 dark:text-[#FCFCFC]'>{t('common.apiBasedExtension.title')}</div>
      <a
