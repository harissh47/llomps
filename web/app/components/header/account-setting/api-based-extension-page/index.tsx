  ...
  return (
    <div>
      ...
      <div
        ...
        className='flex items-center justify-center px-3 h-8 text-[13px] font-medium text-gray-700 dark:text-white rounded-lg bg-gray-50 dark:bg-[#3F3F3F] cursor-pointer'
