          ...
          <div className='mx-2 w-[640px] max-h-[calc(100vh-120px)] bg-white dark:bg-[#333333] shadow-xl rounded-2xl overflow-y-auto'>
            <div className='px-8 pt-8'>
              <div className='flex justify-between items-center mb-4'>
                ...
                <div className='text-xl font-semibold text-gray-900 dark:text-white'>{t(`${I18N_PREFIX}.configFirecrawl`)}</div>
              </div>
              ...
              <div className='my-8 flex justify-between items-center h-8'>
                {/* <a className='flex items-center space-x-1 leading-[18px] text-xs font-normal text-[#155EEF]'  */}
                <a className='flex items-center space-x-1 leading-[18px] text-xs font-normal text-[#8AB40A]' target='_blank' href='https://www.firecrawl.dev/account'>
                  <span>{t(`${I18N_PREFIX}.getApiKeyLinkText`)}</span>
                  <LinkExternal02 className='w-3 h-3' />
                </a>
                <div className='flex'>
                  <Button
                    className='mr-2 h-9 text-sm font-medium text-gray-700 dark:border-0 dark:bg-[#3f3f3f] dark:hover:bg-zinc-800'
                    onClick={onCancel}
                  >
            ...
            <div className='border-t-[0.5px] border-t-black/5'>
              ...
              <div className='flex justify-center items-center py-3 bg-gray-50 dark:bg-[#383838] text-xs text-gray-500 dark:text-[#FCFCFC]'>
