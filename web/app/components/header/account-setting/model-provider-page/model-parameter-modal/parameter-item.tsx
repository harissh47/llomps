      ...
      return (
        <>
          ...
          <input
            ...
            className='shrink-0 block ml-4 pl-3 w-16 h-8 appearance-none outline-none rounded-lg bg-gray-100 text-[13px] text-gra-900 dark:text-[#FCFCFC] dark:bg-[#3f3f3f]'
      ...
      <div>
        <div className={cn(isInWorkflow ? 'w-[140px]' : 'w-full', 'ml-4 shrink-0 flex items-center')}>
          <div
            ...
            className='mr-0.5 text-[13px] font-medium text-gray-700 dark:text-[#FCFCFC] truncate'
