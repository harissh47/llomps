      ...
      <div className={`flex items-center justify-between mb-2 h-8 ${defaultModelNotConfigured && 'px-3 bg-[#FFFAEB] rounded-lg border border-[#FEF0C7]'}`}>
        {
          defaultModelNotConfigured
           ...
           :  <div className='text-sm font-medium text-gray-800 dark:text-white'>{t('common.modelProvider.models')}</div>
        }
        <SystemModelSelector
      ...
      }
      {
        !!notConfigedProviders?.length && (
          <>
            ...
            <div className='flex items-center mb-2 text-xs font-semibold text-gray-500 dark:text-[#FCFCFC]'>
