        ...
        <div className='fixed inset-0 flex items-center justify-center bg-black/[.25]'>
          ...
          <div className={`mx-2 w-[640px] max-h-[calc(100vh-120px)] bg-white ${getDarkThemeClasses('background1')} shadow-xl rounded-2xl overflow-y-auto`}>
            <div className='px-8 pt-8'>
              ...
              <div className={`mt-1 mb-4 border-t-[0.5px] border-t-gray-100 ${getDarkThemeClasses('border')}`} />
                ...
                <div>
                  {
                    isEditMode && (
                      <Button
                        className={`mr-2 h-9 text-sm font-medium text-[#D92D20] ${getDarkThemeClasses('background3')} ${getDarkThemeClasses('hover')} dark:border-0`}
                  ...
                  <Button
                    className={`mr-2 h-9 text-sm font-medium text-gray-700 ${getDarkThemeClasses('background1')} ${getDarkThemeClasses('hover')} ${getDarkThemeClasses('border')}`}
                    onClick={onCancel}
                  >
