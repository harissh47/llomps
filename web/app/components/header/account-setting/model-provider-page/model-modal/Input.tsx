    ...
    <div className='relative '>
      <input
        ...
        className={`
          ...
          appearance-none outline-none caret-primary-600
          hover:border-[rgba(0,0,0,0.08)] hover:bg-gray-50 ${getDarkThemeClasses('hover')} ${getDarkThemeClasses('borderhover')}
          focus:bg-white focus:border-gray-300 focus:shadow-xs ${getDarkThemeClasses('borderfocus')}
          placeholder:text-sm placeholder:text-gray-400 ${getDarkThemeClasses('sub_text1')}
          ${validated && 'pr-[30px]'}
          ${className}
        `}
