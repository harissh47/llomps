  ...
  return (
    ...
    >
      <PortalToFollowElemTrigger onClick={() => setOpen(v => !v)}>
        <div className={`
          flex items-center px-2 h-6 text-xs text-gray-700 dark:text-[#FCFCFC] cursor-pointer bg-white dark:bg-[#3F3F3F] rounded-md border-[0.5px] border-gray-200 dark:border-[#5f5f5f] dark:hover:bg-zinc-800 shadow-xs
      ...
      <PortalToFollowElemContent className='z-50'>
        ...
        <div className='pt-4 w-[360px] rounded-xl border-[0.5px] border-black/5 bg-white dark:bg-[#333333] dark:border-[#5f5f5f] shadow-xl'>
          ...
          <div className='px-6 py-1'>
            ...
            <div className='flex items-center h-8 text-[13px] font-medium text-gray-900 dark:text-white'>
              ...
              <Tooltip
                ...
                htmlContent={
                  <div className='w-[261px] text-gray-500 dark:text-white'>{t('common.modelProvider.ttsModel.tip')}</div>
                }
              >
                <HelpCircle className='ml-0.5 w-[14px] h-[14px] text-gray-400'/>
              </Tooltip>
          ...
          <div className='flex items-center justify-end px-6 py-4'>
            <Button
              className='mr-2 !h-8 !text-[13px] dark:border-0 dark:bg-[#3f3f3f] dark:hover:bg-zinc-800'
