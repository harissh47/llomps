...
const AddToolModal: FC<Props> = ({
  ...
  return (
    <>
      ...
      >
        <div
          className='w-full flex bg-white border-[0.5px] border-gray-200 dark:border-[#5f5f5f] rounded-xl shadow-xl'
          style={{
...
>>>>>>> origin/rupa
          ...
          <div className='relative grow bg-white dark:bg-[#3e3e3e] rounded-r-xl overflow-y-auto'>
            {/* <div className='z-10 sticky top-0 left-0 right-0 p-2 flex items-center gap-1 bg-white'> */}
            <div className='z-10 sticky top-0 left-0 right-0 p-2 flex items-center gap-1 bg-white dark:bg-[#3e3e3e]'>
              <div className='grow'>
