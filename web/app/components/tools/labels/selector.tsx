    ...
    >
      <div className='relative'>
        ...
        >
          ...
          // )}
          className={cn(
            'flex items-center gap-1 px-3 h-9 rounded-lg border-[0.5px] border-transparent bg-gray-100 dark:bg-[#3F3F3F] cursor-pointer hover:bg-gray-200 dark:hover:bg-zinc-800',
            open && '!bg-gray-200 dark:!bg-zinc-800 hover:bg-gray-200 dark:hover:bg-zinc-800',
          )}
          ...
          >
            ...
            <div title={value.length > 0 ? selectedLabels : ''} className={cn('grow text-[13px] leading-[18px] text-gray-700 dark:text-white truncate', !value.length && '!text-gray-400')}>
...
>>>>>>> origin/rupa
              {filteredLabelList.map(label => (
                ...
                >
                  ...
                  <div title={label.label[language]} className='grow text-sm text-gray-700 dark:text-[#FCFCFC] leading-5 truncate'>{label.label[language]}</div>
                </div>
              ))}
