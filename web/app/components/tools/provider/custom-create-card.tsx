  ...
  return (
    <>
      {isCurrentWorkspaceManager && (
        ...
        // <div className='flex flex-col col-span-1 bg-gray-200 dark:bg-[#3f3f3f] border-[0.5px] border-black/5 rounded-xl min-h-[160px] transition-all duration-200 ease-in-out cursor-pointer hover:bg-gray-50 hover:shadow-lg'>

        // {/* <div className='group grow rounded-t-xl hover:bg-white' onClick={() => setIsShowEditCustomCollectionModal(true)}> */}
        // <div className='group grow rounded-t-xl hover:bg-white dark:hover:bg-zinc-800' onClick={() => setIsShowEditCustomCollectionModal(true)}>
        ...
        //       <div className='ml-3 text-sm font-semibold leading-5 text-gray-800 dark:text-white group-hover:text-primary-600'>{t('tools.createCustomTool')}</div>
        <div className='flex flex-col col-span-1 bg-gray-200 dark:bg-[#3f3f3f] border-[0.5px] border-black/5 rounded-xl min-h-[160px] transition-all duration-200 ease-in-out cursor-pointer hover:bg-gray-50 dark:hover:bg-zinc-800 hover:shadow-lg'>
