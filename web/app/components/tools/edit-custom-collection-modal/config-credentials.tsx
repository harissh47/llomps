...
const SelectItem: FC<ItemProps> = ({ text, value, isChecked, onClick }) => {
  return (
    <div
      ...
      className={cn(isChecked ? 'border-[2px] border-indigo-600 shadow-sm bg-white' : 'border border-gray-100 dark:border-[#5f5f5f]', 'mb-2 flex items-center h-9 pl-3 w-[150px] rounded-xl bg-gray-25 dark:bg-[#3F3F3F] hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer space-x-2')}
      onClick={() => onClick(value)}
    >
      <Radio isChecked={isChecked} />
      {/* <div className='text-sm font-normal text-gray-900'>{text}</div> */}
      <div className='text-sm font-normal text-gray-900 dark:text-[#FCFCFC]'>{text}</div>
    </div>
  )
}
      ...
      body={
        <div className='pt-2 px-6'>
                ...
                <div>
                  ...
                  <div className='flex items-center h-8 text-[13px] font-medium text-gray-900 dark:text-white'>
                    ...
                    <Tooltip
                      ...
                      htmlContent={
                        <div className='w-[261px] text-gray-500 dark:text-white '>
                  ...
                  <input
                    ...
                    className='w-full h-10 px-3 text-sm font-normal bg-gray-100 dark:bg-[#3F3F3F] dark:text-[#FCFCFC] rounded-lg grow dark:focus:outline-none focus:border-2 dark:focus:border-[#5f5f5f]'
          ...
          <div className='mt-4 shrink-0 flex justify-end space-x-2 py-4'>
            ...
            <Button className='flex items-center h-8 !px-3 !text-[13px] font-medium !text-gray-700 dark:!text-white dark:border-0 dark:bg-[#3f3f3f] dark:hover:bg-zinc-800
