...
const fieldNameClassNames = 'py-2 leading-5 text-sm font-medium text-gray-900 dark:text-white'
      ...
      <Drawer
        ...
        body={
          <div className='flex flex-col h-full'>
            <div className='grow h-0 overflow-y-auto px-6 py-3 space-y-4'>
              <div>
                ...
                <div className='flex items-center justify-between gap-3'>
                  ...
                  <input
                    ...
                    className='h-10 px-3 text-sm font-normal bg-gray-100 dark:bg-[#3f3f3f] dark:focus:outline-none focus:border-2 dark:focus:border-[#5f5f5f] rounded-lg grow dark:text-white' placeholder={t('tools.createTool.toolNamePlaceHolder')!}
              ...
              <div className='select-none'>
                <div className='flex justify-between items-center'>
                  <div className='flex items-center'>
                    ...
                    <a
                      ...
                      className='flex items-center h-[18px] space-x-1  text-[#8AB40A]'
                    >
                ...
                <textarea
                  ...
                  className='w-full h-[240px] px-3 py-2 leading-4 text-xs font-normal text-gray-900 bg-gray-100 dark:bg-[#3f3f3f] rounded-lg overflow-y-auto dark:text-white dark:focus:outline-none focus:border-2 dark:focus:border-[#5f5f5f]'
              ...
              <div>
                ...
                <div className='rounded-lg border border-gray-200 dark:border-[#5f5f5f] w-full overflow-x-auto'>

                  <table className='w-full leading-[18px] text-xs text-gray-700 font-normal'>
                    {/* <thead className='text-gray-500 uppercase'> */}
                    <thead className='text-gray-500 dark:text-[#FCFCFC] uppercase'>
                    ...
                    <tbody>
                      {paramsSchemas.map((item, index) => (
                        <tr key={index} className='border-b last:border-0 border-gray-200'>
                          <td className="p-2 pl-3 dark:text-[#A1A6B2]">{item.operation_id}</td>
                          <td className="p-2 pl-3 text-gray-500 w-[236px] dark:text-[#A1A6B2]">{item.summary}</td>
                          <td className="p-2 pl-3 dark:text-[#A1A6B2]">{item.method}</td>
                          <td className="p-2 pl-3 dark:text-[#A1A6B2]">{getPath(item.server_url)}</td>
                          <td className="p-2 pl-3 w-[62px]">
                            <Button
                              // className='!h-6 !px-2 text-xs font-medium text-gray-700 whitespace-nowrap'
                              className='!h-6 !px-2 text-xs font-medium text-gray-700 dark:border-[#5F5F5F] dark:bg-[#3F3F3F] dark:hover:bg-zinc-800 whitespace-nowrap'
                              onClick={() => {
                                setCurrTool(item)
              ...
              <div>
                ...
                <div className='flex items-center h-9 justify-between px-2.5 bg-gray-100 dark:bg-[#3F3F3F] rounded-lg cursor-pointer' onClick={() => setCredentialsModalShow(true)}>
                  {/* <div className='text-sm font-normal text-gray-900'>{t(`tools.createTool.authMethod.types.${credential.auth_type}`)}</div> */}
                  <div className='text-sm font-normal text-gray-900 dark:text-[#FCFCFC]'>{t(`tools.createTool.authMethod.types.${credential.auth_type}`)}</div>
              ...
              <div>
                ...
                <div className='py-2 leading-5 text-sm font-medium text-gray-900 dark:text-white'>{t('tools.createTool.toolInput.label')}</div>
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full h-10 px-3 text-sm font-normal bg-gray-100 dark:bg-[#3F3F3F] dark:text-[#FCFCFC] rounded-lg grow dark:focus:outline-none focus:border-2 dark:focus:border-[#5f5f5f]' placeholder={t('tools.createTool.privacyPolicyPlaceholder') || ''} />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full h-10 px-3 text-sm font-normal bg-gray-100 dark:bg-[#3F3F3F] dark:text-[#FCFCFC] rounded-lg grow dark:focus:outline-none focus:border-2 dark:focus:border-[#5f5f5f]' placeholder={t('tools.createTool.customDisclaimerPlaceholder') || ''} />
              </div>
            ...
            <div className={cn(isEdit ? 'justify-between' : 'justify-end', 'mt-2 shrink-0 flex py-4 px-6 rounded-b-[10px] bg-gray-50 dark:bg-[#383838] border-t border-black/5')} >
              ...
              <div className='flex space-x-2 '>
                ...
                <Button className='flex items-center h-8 !px-3 !text-[13px] font-medium !text-gray-700 bg-white dark:!text-white dark:border-0 dark:bg-[#3f3f3f] dark:hover:bg-zinc-800' onClick={onHide}>{t('common.operation.cancel')}</Button>
