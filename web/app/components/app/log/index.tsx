...
const EmptyElement: FC<{ appUrl: string }> = ({ appUrl }) => {
 ...
 <div className='bg-gray-50 dark:bg-[#3F3F3F] w-[560px] h-fit box-border px-5 py-4 rounded-2xl'>
 {/* <span className='text-gray-700 dark:text-white font-semibold'>{t('appLog.table.empty.element.title')}<ThreeDotsIcon className='inline relative -top-3 -left-1.5' /></span> */}
...
const Logs: FC<ILogsProps> = ({ appDetail }) => {
  ...
  return (
    <div className='flex flex-col h-full'>
      ...
      <p className='flex text-sm font-normal text-gray-500 dark:text-[#FCFCFC]'>{t('appLog.description')}</p>
