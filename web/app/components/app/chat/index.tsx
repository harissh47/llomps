      ...
      {!isHideSendInput && (
        <div className={cn(!feedbackDisabled && '!left-3.5 !right-3.5', 'absolute z-10 bottom-0 left-0 right-0')}>
          ...
          <div className='relative'>
            ...
            <div className={cn(`relative p-[5.5px] max-h-[150px] rounded-xl overflow-y-auto ${s.textAreaOverlay}`, isDragActive && 'border-primary-600')}>
              ...
              <Textarea
                className={`
                  ${s.textArea} block w-full px-2 pr-[118px] py-[7px] leading-5 max-h-none text-sm text-white-700 outline-none appearance-none resize-none
