...
const Log: FC<LogProps> = ({
  ...
  return (
    <div
      ...
      className='shrink-0 p-1 flex items-center justify-center rounded-[6px] font-medium text-gray-500 dark:text-[#A1A6B2] hover:bg-gray-50 dark:hover:bg-zinc-800 cursor-pointer hover:text-gray-700 dark:hover:text-[#A1A6B2]'
      onClick={(e) => {
        e.stopPropagation()
    ...
    >
      <File02 className='mr-1 w-4 h-4 dark:text-[#6B7280]' />
