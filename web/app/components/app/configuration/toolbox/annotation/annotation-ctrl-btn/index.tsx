...
const CacheCtrlBtn: FC<Props> = ({
  ...
  return (
    <div className={cn(className, 'inline-block')}>
      ...
      <div className='inline-flex p-0.5 space-x-0.5 rounded-lg bg-white dark:bg-[#3f3f3f] border border-gray-100 dark:border-[#5f5f5f] shadow-md text-gray-500 dark:text-white cursor-pointer'>
        ...
        {cached
          ? (
            <div>
              <div
                ref={cachedBtnRef}
                className={cn(isCachedBtnHovering ? 'bg-[#FEF3F2] text-[#D92D20]' : 'bg-[#EEF4FF] text-[#8AB40A]', 'flex p-1 space-x-1 items-center rounded-md leading-4 text-xs font-medium')}
          ...
          : answer
            ? (
              ...
              >
                <div
                  className='p-1 rounded-md hover:bg-[#EEF4FF] hover:text-[#8AB40A] cursor-pointer'
                  onClick={handleAdd}
                >
