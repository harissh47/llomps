...
const ConfigParamModal: FC<Props> = ({
  ...
  return (
    ...
    >
      <div className='mb-2 text-xl font-semibold text-[#1D2939] dark:text-white'>
      ...
      <div className='mt-6 flex gap-2 justify-end'>
        <Button className='!text-sm dark:bg-[#3F3F3F] dark:text-white dark:bg-[#333333] dark:border-[#5F5F5F] dark:hover:bg-zinc-800' onClick={onHide}>{t('common.operation.cancel')}</Button>
        <Button
          type='primary'
          onClick={handleSave}
          className='flex items-center border-[0.5px] !text-sm dark:border-0'
          loading={isLoading}
        >
          <div></div>
