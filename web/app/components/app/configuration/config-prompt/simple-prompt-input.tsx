      ...
      <div className='rounded-xl bg-[#EEF4FF] dark:bg-[#EEF4FF]'>
        ...
        <PromptEditorHeightResizeWrap
          // className='px-4 pt-2 min-h-[228px] bg-white rounded-t-xl text-sm text-gray-700'
           className='px-4 pt-2 min-h-[228px] bg-white dark:bg-[#3f3f3f] rounded-t-xl text-sm text-gray-700'
          height={editorHeight}
          minHeight={minHeight}
          onHeightChange={setEditorHeight}
          footer={(
            // <div className='pl-4 pb-2 flex bg-white rounded-b-xl'>
              <div className='pl-4 pb-2 flex bg-white rounded-b-xl  dark:bg-[#3f3f3f] dark:text-white'>
              {/* <div className="h-[18px] leading-[18px] px-1 rounded-md bg-gray-100 text-xs text-gray-500"> */}
              <div className="h-[18px] leading-[18px] px-1 rounded-md bg-gray-100 text-xs text-gray-500  dark:bg-[#1A1A1A] dark:text-white">{promptTemplate.length}</div>
            </div>
          )}
        >
          <PromptEditor
