...
const DebugItem: FC<DebugItemProps> = ({
  ...
  return (
    <div
      ...
      className={`flex flex-col min-w-[320px] rounded-xl bg-white dark:bg-[#3F3F3F] border-[0.5px] border-black/5 overflow-hidden ${className}`}
      style={style}
    >
      {/* <div className='shrink-0 flex items-center justify-between h-10 px-3 border-b-[0.5px] border-b-black/5'> */}
      <div className='shrink-0 flex items-center justify-between h-10 px-3 border-b-[0.5px] border-b-black/5 dark:bg-[#3f3f3f]'>
        {/* <div className='flex items-center justify-center w-6 h-5 font-medium italic text-gray-500'> */}
        <div className='flex items-center justify-center w-6 h-5 font-medium italic text-gray-500 dark:text-white'>
          #{index + 1}
        </div>
