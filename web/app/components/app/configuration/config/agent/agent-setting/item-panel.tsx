...
const ItemPanel: FC<Props> = ({
  ...
  return (
    ...
    <div className={cn(className, 'flex justify-between items-center h-12 px-3 rounded-lg bg-gray-50 dark:!bg-[#2c2c2c]')}>
      <div className='flex items-center'>
        {icon}
        {/* <div className='ml-3 mr-1 leading-6 text-sm font-semibold text-gray-800'>{name}</div> */}
        <div className='ml-3 mr-1 leading-6 text-sm font-semibold text-gray-800 dark:text-white'>{name}</div>
        <Tooltip
          htmlContent={
