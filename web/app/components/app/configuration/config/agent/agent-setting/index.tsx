  ...
  return (
    ...
    >
      <div
        ...
        className='w-[640px] flex flex-col h-full overflow-hidden bg-white dark:bg-[#3e3e3e] border-[0.5px] border-gray-200 dark:border-[#5f5f5f] rounded-xl shadow-xl'
      >
        <div className='shrink-0 flex justify-between items-center pl-6 pr-5 h-14 border-b border-b-gray-100 dark:border-[#5f5f5f]'>
        ...
        <div className='grow p-6 pt-5 border-b overflow-y-auto pb-[68px]' style={{
          ...
          >
            ...
            <div className='leading-[18px] text-[13px] font-medium text-gray-900 dark:text-white'>{isFunctionCall ? t('appDebug.agent.agentModeType.functionCall') : t('appDebug.agent.agentModeType.ReACT')}</div>
          </ItemPanel>
          ...
          >
            <div className='flex items-center'>
              ...
              <input
                ...
                className="block w-11 h-7 leading-7 rounded-lg border-0 pl-1 px-1.5 bg-gray-100 dark:bg-[#5F5F5F] text-gray-900 placeholder:text-gray-400 dark:text-white focus:ring-1 focus:ring-inset focus:ring-primary-600 dark:focus:outline-none focus:border-2 dark:focus:border-[#5f5f5f]
"
                value={tempPayload.max_iteration}
                onChange={(e) => {
          ...
          {!isFunctionCall && (
            ...
            <div className='py-2 bg-gray-50 dark:bg-[#2c2c2c] rounded-xl shadow-xs'>
              ...
              <div className='flex items-center h-8 px-4 leading-6 text-sm font-semibold text-gray-700 dark:text-[#A1A2B6]'>{t('tools.builtInPromptTitle')}</div>
              <div className='h-[396px] px-4 overflow-y-auto leading-5 text-sm font-normal text-gray-700 dark:text-[#A1A2B6] whitespace-pre-line'>
              ...
              <div className='px-4'>
                ...
                <div className='inline-flex items-center h-5 px-1 rounded-md bg-gray-100 dark:bg-[#383838] leading-[18px] text-xs font-medium text-gray-500 dark:text-[#6B7280]'>{(isChatModel ? DEFAULT_AGENT_PROMPT.chat : DEFAULT_AGENT_PROMPT.completion).length}</div>
              </div>
            </div>
          )}
        ...
        <div
          // className='sticky z-[5] bottom-0 w-full flex justify-end py-4 px-6 border-t bg-white '
           className='sticky z-[5] bottom-0 w-full flex justify-end py-4 px-6 border-t dark:border-[#5f5f5f] bg-white dark:bg-[#3e3e3e]'
          style={{
        ...
        >
          <Button
            ...
            // className='mr-2 text-sm font-medium'
              className='mr-2 text-sm font-medium dark:bg-[#3e3e3e] dark:border-[#5f5f5f] dark:hover:bg-zinc-800'
          >
