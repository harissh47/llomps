  ...
  return (
    ...
    >
      <div className='flex h-[680px] flex-wrap gap-y-4 overflow-y-auto'>
        ...
        {isShowAutoPromptInput() && <div className='w-full sm:w-[360px] xl:w-[480px] shrink-0 px-8 py-6 h-full overflow-y-auto border-r border-gray-100 dark:border-[#5F5F5F]'>
          <div>
            ...
            <div className='text-[13px] font-normal text-gray-500 dark:text-white'>{t('appDebug.automatic.description')}</div>
          </div>
          {/* inputs */}
          <div className='mt-2 space-y-5'>
            <div className='space-y-2'>
              {/* <div className='text-[13px] font-medium text-gray-900'>{t('appDebug.automatic.intendedAudience')}</div> */}
              <div className='text-[13px] font-medium text-gray-900 dark:text-white'>{t('appDebug.automatic.intendedAudience')}</div>
              ...
              <input className="w-full h-8 px-3 text-[13px] font-normal bg-gray-50 dark:bg-[#3F3F3F] dark:focus:outline-none focus:border-2 dark:focus:border-[#5F5F5F] dark:caret-primary-600 dark:text-[#FCFCFC] rounded-lg" placeholder={t('appDebug.automatic.intendedAudiencePlaceHolder') as string} value={audiences} onChange={e => setAudiences(e.target.value)} />
            </div>
            <div className='space-y-2'>
              {/* <div className='text-[13px] font-medium text-gray-900'>{t('appDebug.automatic.solveProblem')}</div> */}
              <div className='text-[13px] font-medium text-gray-900 dark:text-white'>{t('appDebug.automatic.solveProblem')}</div>
              ...
              <textarea className="w-full h-[200px] overflow-y-auto p-3 text-[13px] font-normal bg-gray-50 dark:bg-[#3F3F3F] dark:focus:outline-none focus:border-2 dark:focus:border-[#5F5F5F] dark:caret-primary-600 dark:text-[#FCFCFC] rounded-lg" placeholder={t('appDebug.automatic.solveProblemPlaceHolder') as string} value={hopingToSolve} onChange={e => setHopingToSolve(e.target.value)} />
            </div>
