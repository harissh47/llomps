...
const AgentSettingButton: FC<Props> = ({
  ...
  return (
    <>
      <Button onClick={() => setIsShowAgentSetting(true)} className='shrink-0 mr-2 !px-3 !h-8 !text-[13px] font-medium text-gray-700 dark:hover:shadow-[#5F5F5F] dark:border-[#5F5F5F] dark:hover:bg-transparent'>
