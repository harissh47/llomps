  ...
  return (
    <div>
      {/* <div
        ...
        <div
        className={cn('flex items-center rounded-md h-7 px-3 space-x-1 text-gray-700 cursor-pointer hover:bg-gray-200 dark:text-white dark:hover:bg-zinc-600 cursor-pointer dark:text-white', open && 'bg-gray-200 dark:bg-[#1A1A1A] dark:text-white dark:hover:bg-zinc-600 cursor-pointer dark:text-white')}
        onClick={() => {
        ...
        open && (
          ...
          >
            ...
            <div className='mt-6 flex justify-end'>
              <Button className='mr-2 flex-shrink-0 dark:bg-[#333333] dark:border-[#5f5f5f] dark:hover:bg-zinc-800' onClick={() => {
                setOpen(false)
