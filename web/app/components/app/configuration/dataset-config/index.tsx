...
const Icon = (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fill="#616161" fill-rule="evenodd" clip-rule="evenodd" d="M20.73,2.67H3.27a2.67,2.67,0,0,0-2.67,2.67V19.67A2.67,2.67,0,0,0,3.27,25h17.46a2.67,2.67,0,0,0,2.67-2.67V5.33A2.67,2.67,0,0,0,20.73,2.67Zm.67,22.67a.67.67,0,0,1-.67.67H3.27a.67.67,0,0,1-.67-.67V5.33a.67.67,0,0,1,.67-.67h17.46a.67.67,0,0,1,.67.67ZM17.75,9.67H6.25a.67.67,0,1,0,0,1.33H17.75a.67.67,0,1,0,0-1.33ZM17.75,13.67H6.25a.67.67,0,1,0,0,1.33H17.75a.67.67,0,1,0,0-1.33ZM17.75,17.67H6.25a.67.67,0,1,0,0,1.33H17.75a.67.67,0,1,0,0-1.33Z"/>
    ...
    >
      {hasData
        ...
        : (
          ...
          <div className='pt-2 pb-1 text-xs text-gray-500 dark:text-white'>{t('appDebug.feature.dataSet.noData')}</div>
          </div>
        )}
