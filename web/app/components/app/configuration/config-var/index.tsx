  ...
  return (
    <Panel
      ...
      title={
        <div className='flex items-center'>
          ...
          <div className='mr-1  dark:bg-[#3f3f3f] dark:text-white'>{t('appDebug.variableTitle')}</div>
          {!readonly && (
    ...
    >
      {!hasVar && (
        ...
        <div className='pt-2 pb-1 text-xs text-gray-500 dark:text-white'>{t('appDebug.notSetVar')}</div>
      )}
      {hasVar && (
        // <div className='rounded-lg border border-gray-200 bg-white overflow-x-auto'>
          <div className='rounded-lg border border-gray-200 dark:border-[#5F5F5F] bg-white overflow-x-auto dark:bg-[#3f3f3f] dark:text-white'>
          <table className={`${s.table} min-w-[440px] w-full max-w-full border-collapse border-0 rounded-lg text-sm`}>
            ...
            <thead className="border-b  border-gray-200 dark:border-[#5F5F5F] text-gray-500 text-xs font-medium">
              {/* <tr className='uppercase'> */}
              <tr className='uppercase dark:text-white'>
            ...
            <tbody className="text-gray-700">
              {promptVariables.map(({ key, name, type, required, config, icon, icon_background }, index) => (
                <tr key={index} className="h-9 leading-9">
                  ...
                  <td className="w-[160px] border-b border-gray-100 dark:border-[#5F5F5F] pl-3">
                    <div className='flex items-center space-x-1'>
                      ...
                      {!readonly
                        ? (
                          ...
                          // />
                          className="h-6 leading-6 block w-full rounded-md border-0 py-1.5 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-gray-200 dark:bg-[#3F3F3F] dark:focus:ring-[#5F5F5F] dark:text-white"
                          />
                        )
                        : (
                  ...
                  <td className="py-1 border-b border-gray-100 dark:border-[#5F5F5F]">
                    {!readonly
                      ? (
                        <input
                          type="text"
                  ...
                  {!readonly && (
                    <>
                      <td className='w-[84px] border-b border-gray-100 dark:border-[#5F5F5F]'>
                        <div className='flex items-center h-full'>
                          <Switch defaultValue={!required} size='md' onChange={value => updatePromptVariable(key, 'required', !value)} />
                        </div>
                      </td>
                      <td className='w-20  border-b border-gray-100 dark:border-[#5F5F5F]'>
