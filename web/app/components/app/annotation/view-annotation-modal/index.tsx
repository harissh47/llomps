      ...
      <Drawer
        ...
        foot={id
          ? (
            ...
            <div className='px-4 flex h-16 items-center justify-between border-t border-black/5 bg-gray-50 dark:bg-[#3e3e3e] rounded-bl-xl rounded-br-xl leading-[18px] text-[13px] font-medium text-gray-500'>
              <div
