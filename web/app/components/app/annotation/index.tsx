          ...
          <div className='flex items-center space-x-2'>
            {isChatApp && (
              <>
                ...
                <div className={cn(!annotationConfig?.enabled && 'pr-2', 'flex items-center h-7 rounded-lg border border-gray-200 dark:border-[#3f3f3f] pl-2 space-x-1')}>

                  <div className='leading-[18px] text-[13px] font-medium text-gray-900 dark:text-primary-600'>{t('appAnnotation.name')}</div>
                  <Switch
