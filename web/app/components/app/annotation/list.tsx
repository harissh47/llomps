      ...
      <table className={cn(s.logTable, 'w-full min-w-[440px] border-collapse border-0 text-sm')} >
        ...
        <tbody className="text-gray-500 dark:text-white">
          {list.map(item => (
            ...
            >
              <td
                className='whitespace-nowrap overflow-hidden text-ellipsis dark:text-white max-w-[250px]'
                title={item.question}
              >{item.question}</td>
              <td
                className='whitespace-nowrap overflow-hidden text-ellipsis dark:text-white max-w-[250px]'
              ...
              <td className='w-[96px]' onClick={e => e.stopPropagation()}>
                ...
                <div className='flex space-x-2 text-gray-500'>
                  <div
                    className='p-1 cursor-pointer rounded-md hover:bg-black/5 dark:hover:bg-zinc-600'
                    onClick={
                      () => {
                        onView(item)
                      }
