        ...
        foot={
          (
            <div>
              ...
              <div className='px-6 flex h-16 items-center justify-between border-t border-black/5 bg-gray-50 rounded-bl-xl rounded-br-xl leading-[18px] text-[13px] font-medium text-gray-500 dark:bg-[#3e3e3e]'>
                <div
                ...
                <div className='mt-2 flex space-x-2'>
                  ...
                  <Button className='!h-7 !text-xs !font-medium dark:bg-[#3e3e3e] dark:border-[#5f5f5f] dark:hover:bg-zinc-800' onClick={onHide}>{t('common.operation.cancel')}</Button>
