  ...
  return (
    <>
      ...
      >
        ...
        <div className='relative mt-3 text-xl font-semibold leading-[30px] text-gray-900 dark:text-white'>{t('app.switch')}</div>
        {/* <div className='my-1 text-gray-500 text-sm leading-5'> */}
        <div className='my-1 text-gray-500 dark:text-[#FCFCFC] text-sm leading-5'>
          <span>{t('app.switchTipStart')}</span>
          {/* <span className='text-gray-700 font-medium'>{t('app.switchTip')}</span> */}
          <span className='text-gray-700 dark:text-[#6B7280] font-medium'>{t('app.switchTip')}</span>
          <span>{t('app.switchTipEnd')}</span>
        </div>
        <div className='pb-4'>
          {/* <div className='py-2 text-sm font-medium leading-[20px] text-gray-900'>{t('app.switchLabel')}</div> */}
          <div className='py-2 text-sm font-medium leading-[20px] text-gray-900 dark:text-white'>{t('app.switchLabel')}</div>
        ...
        <div className='pt-6 flex justify-between items-center'>
          <div className='flex items-center'>
            ...
            <label htmlFor="removeOriginal" className="ml-2 text-sm leading-5 text-gray-700 dark:text-[#6B7082] cursor-pointer">{t('app.removeOriginal')}</label>
          </div>
          <div className='flex items-center'>
