...
const CreateAppModal = ({ show, onSuccess, onClose }: CreateAppDialogProps) => {
  ...
  return (
    ...
    >
      ...
      <div className={`shrink-0 flex flex-col h-full bg-white rounded-t-xl ${getDarkThemeClasses('background')}`}>
        ...
        <div className={`shrink-0 pl-8 pr-6 pt-6 pb-3 bg-white text-xl rounded-t-xl leading-[30px] font-semibold text-gray-900 z-10 ${getDarkThemeClasses('background')}`}>{t('app.newApp.startFromBlank')}</div>
      </div>
      {/* app type */}
      {/* <div className='py-2 px-8 '> */}
      <div className={`py-2 px-8 ${getDarkThemeClasses('background')}`}>
        {/* <div className='py-2 text-sm leading-[20px] font-medium text-gray-900 '>{t('app.newApp.captionAppType')}</div> */}
        <div className={`py-2 text-sm leading-[ 20px] font-medium text-gray-900 ${getDarkThemeClasses('background')}`}>{t('app.newApp.captionAppType')}</div>
        <div className='flex'>
          <TooltipPlus
            hideArrow
            popupContent={
      ...
      {showChatBotType && (
        ...
        <div className={`py-2 px-8 ${getDarkThemeClasses('background')}`}>
          ...
          <div className={`py-2 text-sm leading-[20px] font-medium text-gray-900 ${getDarkThemeClasses('background')}`}>{t('app.newApp.chatbotType')}</div>
      ...
      <div className={`pt-2 px-8 ${getDarkThemeClasses('background')}`}>
        {/* <div className='py-2 text-sm font-medium leading-[20px] text-gray-900'>{t('app.newApp.captionName')}</div> */}
        <div className={`py-2 text-sm font-medium leading-[20px] text-gray-900 ${getDarkThemeClasses('background')}`}>{t('app.newApp.captionName')}</div>
      ...
      <div className={`pt-2 px-8 ${getDarkThemeClasses('background')}`}>
        <div className={`py-2 text-sm font-medium leading-[20px] text-gray-900 ${getDarkThemeClasses('background')}`}>{t('app.newApp.captionDescription')}</div>
        <textarea
      ...
      <div className={`px-8 py-6 flex justify-end ${getDarkThemeClasses('background')}`}>
        <Button className={`mr-2 text-gray-700 text-sm font-medium ${getDarkThemeClasses('background')} dark:text-white dark:hover:bg-zinc-800 dark:border-[#5F5F5F]`} onClick={onClose}>{t('app.newApp.Cancel')}</Button>
