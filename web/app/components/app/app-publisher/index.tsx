...
const AppPublisher = ({
  ...
  // const landingAppURL = `${appBaseURL}/landing/${appMode}/${accessToken}`
  const landingAppURL = `${appBaseURL}/landing/${accessToken}`
  ...
  return (
    ...
    >
      ...
      <PortalToFollowElemContent className='z-[11]'>
        ...
        <div className='w-[336px] bg-white dark:bg-[#333333] rounded-2xl border-[0.5px] border-gray-200 dark:border-[#5F5F5F] shadow-xl'>

          <div className='p-4 pt-3'>
            {/* <div className='flex items-center h-6 text-xs font-medium text-gray-500 uppercase'> */}
            <div className='flex items-center h-6 text-xs font-medium text-gray-500 dark:text-[#FCFCFC] uppercase'>
            ...
            {publishedAt
              ? (
                <div className='flex justify-between items-center h-[18px]'>
                  ...
                  <div className='flex items-center mt-[3px] mb-[3px] leading-[18px] text-[13px] font-medium text-gray-700 dark:text-[#FCFCFC]'>
                  ...
                  <Button
                    ...
                    // `}
                    className={`
                      ml-2 px-2 py-0 h-6 shadow-xs rounded-md text-xs font-medium text-primary-600 border-[0.5px] bg-white dark:bg-[#3F3F3F] border-gray-200 dark:border-[#5F5F5F] dark:hover:shadow-[#5F5F5F] dark:hover:bg-transparent
                      ${published && 'text-primary-300 border-gray-100'}
                    `}
          ...
          <div className='p-4 pt-3 border-t-[0.5px] border-t-black/5'>
            <SuggestedAction disabled={!publishedAt} link={landingAppURL} icon={<PlayCircle />}>{t('workflow.common.runApp')}</SuggestedAction>
            <SuggestedAction disabled={!publishedAt} link={appURL} icon={<PlayCircle />}>{'Run Test App'}</SuggestedAction>
