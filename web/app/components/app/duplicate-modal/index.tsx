  ...
  return (
    <>
      ...
      >
        ...
        <div className={cn('mb-2 font-semibold text-[20px] leading-[30px] text-[#101828] dark:text-white')}>
         {t('app.duplicateTitle')}
        </div>

        <div className={s.content}>
          {/* <div className={s.subTitle}>{t('explore.appCustomize.subTitle')}</div> */}
          <div className={cn('mb-2 font-medium dark:text-white')}>
          ...
          <div className='flex items-center justify-between space-x-2'>
            ...
            <input
              ...
              className='h-10 px-3 text-sm font-normal bg-gray-100 dark:bg-[#3F3F3F] dark:text-[#FCFCFC] rounded-lg grow'
            />
          </div>
