...
const Empty = () => {
  ...
  return (
    // <div className='mb-2 p-6 rounded-2xl bg-gray-50'>
       <div className={`mb-2 p-6 rounded-2xl bg-gray-50 ${getDarkThemeClasses('background4')} border-2  ${getDarkThemeClasses('border4')} border-solid rounded-xl shadow-sm  ${getDarkThemeClasses('hover')} cursor-pointer ${getDarkThemeClasses('hover')} `}>
      {/* <div className='flex items-center justify-center mb-3 w-12 h-12 rounded-[10px] border border-[#EAECF5]'> */}
      <div className={ `flex items-center justify-center mb-3 w-12 h-12 rounded-[10px] border border-[#EAECF5]  ${getDarkThemeClasses('border')}  ${getDarkThemeClasses('background4')}`}>
      ...
      <div className={`mb-2 text-sm text-gray-600  ${getDarkThemeClasses('text')} ${getDarkThemeClasses('hover')}`}>API extensions provide centralized API management, simplifying configuration for easy use across applications.</div>
      {/* <a
