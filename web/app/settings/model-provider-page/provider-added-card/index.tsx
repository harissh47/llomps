...
const ProviderAddedCard: FC<ProviderAddedCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {
        collapsed && (
          <div className='group flex items-center justify-between pl-2 py-1.5 pr-[11px] border-t border-t-black/5 bg-white/30 dark:rounded-b-xl text-xs font-medium text-gray-500'>
