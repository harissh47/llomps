...
const AddModelButton: FC<AddModelButtonProps> = ({
  ...
  return (
    <span
      className={`
        shrink-0 flex items-center px-1.5 h-6 text-xs font-medium text-gray-500 dark:text-[#fcfcfc] cursor-pointer
      hover:bg-primary-50 hover:text-primary-600 dark:hover:text-primary-600   rounded-md ${className}
      `}
      onClick={onClick}
    >
