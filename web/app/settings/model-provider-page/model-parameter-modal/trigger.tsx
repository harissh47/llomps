  ...
  return (
    <div
      className={cn(
        ...
        !isInWorkflow && (disabled ? 'border-[#F79009] bg-[#FFFAEB]' : 'border-[#8AB40A] bg-primary-50'),
        isInWorkflow && 'pr-[30px] bg-gray-100 dark:bg-[#3F3F3F] border border-gray-100  hover:border-gray-200',
      )}
    >
      {
        currentProvider && (
