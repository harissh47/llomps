          ...
          <div className='mx-2 w-[640px] max-h-[calc(100vh-120px)] bg-white dark:bg-[#333333] shadow-xl rounded-2xl overflow-y-auto'>
            <div className='px-8 pt-8 '>
              ...
              <div className='my-8 flex justify-between items-center h-8'>
                ...
                <div className='flex'>
                  <Button
                    className='mr-2 h-9 text-sm font-medium text-gray-700 dark:border-[#5F5F5F] dark:hover:bg-zinc-800 dark:bg-[#333333]'
                    onClick={onCancel}
                  >
            ...
            <div className='border-t-[0.5px] border-t-[black]/5 dark:border-t-[black]/5'>
