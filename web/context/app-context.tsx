  ...
  return (
    <AppContext.Provider value={{
      ...
      <div className='flex flex-col h-full overflow-y-auto'>
        ...
        {/* <div ref={pageContainerRef} className='grow relative flex flex-row bg-gray-100 overflow-y-auto'> */}
        <div ref={pageContainerRef} className='grow relative flex flex-row bg-gray-100 overflow-y-auto dark:bg-[#383838]'>
          {children}
        </div>
      </div>
    </AppContext.Provider>
