...
export const createGuestTenant = (url: string, params: CreateGuestTenantBody): Promise<CommonResponse> => {
  return post<CommonResponse>(url, params);  // Send the parameters as the request body
};
