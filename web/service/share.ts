...
export const updateFormMemory = async (isInstalledApp: boolean, installedAppId = '', bodyValue: object) => {
  return getAction('post', isInstalledApp)(getUrl('action-memory', isInstalledApp, installedAppId), { body:  bodyValue })
}
