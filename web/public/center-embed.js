...
async function embedChatbot() {
    ...
    function createIframe() {
        ...
        // iframe.style.cssText = 'border: none; position: fixed; flex-direction: column; justify-content: space-between; box-shadow: rgba(150, 150, 150, 0.2) 0px 10px 30px 0px, rgba(150, 150, 150, 0.2) 0px 0px 0px 1px; bottom: 3rem; left: 6rem; width: 75rem; max-width: calc(100vw - 2rem); height: 40rem; max-height: calc(100vh - 6rem);border-radius: 0.75rem; display: flex; z-index: 2147483647; overflow: hidden; background-color: #F3F4F6;'
        // iframe.style.cssText = 'width: 80vw; height: 80vh; position:fixed; box-sizing: border-box; box-shadow: rgba(150, 150, 150, 0.2) 0px 10px 30px 0px, rgba(150, 150, 150, 0.2) 0px 0px 0px 1px; border:1px solid #e5e7eb; border-radius: 8px; overflow:auto; top:0.2rem; bottom:0.2rem; margin:auto; right:0; left:0'
        iframe.style.cssText = 'width: 80vw; height: 80vh; min-height: 50vh; position:fixed; box-sizing: border-box; box-shadow: rgba(150, 150, 150, 0.2) 0px 10px 30px 0px, rgba(150, 150, 150, 0.2) 0px 0px 0px 1px; border:1px solid #e5e7eb; border-radius: 8px; overflow:auto; top:0.2rem; bottom:0.2rem; margin:auto; right:0; left:0'
