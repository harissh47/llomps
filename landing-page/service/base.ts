...
import { MessageEnd, MessageReplace, ThoughtItem } from "@/app/components/app/chat/type"
import { VisionFile } from "@/types/app"
import { IterationFinishedResponse, IterationNextedResponse, IterationStartedResponse, NodeFinishedResponse, NodeStartedResponse, TextChunkResponse, TextReplaceResponse, WorkflowFinishedResponse, WorkflowStartedResponse } from "@/types/workflow"
            ...
            return handleStream(res, (str: string, isFirstMessage: boolean, moreInfo: IOnDataMoreInfo) => {
                if (moreInfo.errorMessage) {
                    ...
                    if (moreInfo.errorMessage !== 'AbortError: The user aborted a request.')
                        ...
                        console.log('error', moreInfo.errorMessage)
                    return
                }
