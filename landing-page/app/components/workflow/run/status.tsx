        ...
        >
            <div className='flex'>
                <div className='flex-[33%] max-w-[120px]'>
                    <div className='text-xs leading-[18px] font-medium text-gray-400'>{'STATUS'}</div>
                    <div
                        className={cn(
                ...
                <div className='flex-[33%] max-w-[152px]'>
                    <div className='text-xs leading-[18px] font-medium text-gray-400'>{'ELAPSED TIME'}</div>
                ...
                <div className='flex-[33%]'>
                    <div className='text-xs leading-[18px] font-medium text-gray-400'>{'TOTAL TOKENS'}</div>
                    <div className='flex items-center gap-1 h-[18px] text-gray-700 text-xs leading-3 font-semibold'>
                        {status === 'running' && (
