...
const HeaderInMobile = () => {
  ...
  const toggleCollapse = () => setShowSidebar(!showSidebar)
  ...
  return (
    <>
      ...
      <div className='shrink-0 flex items-center px-3 h-[44px] border-b-[0.5px] border-b-[#2C2C2C]'>
        <div
        ...
        <div className='grow flex justify-center items-center px-3'>
          ...
          <div className='py-1 text-base font-semibold text-white truncate'>
            {appData?.site.title}
          </div>
        </div>
        <div
      ...
      </div>
      {
        showSidebar && (
          ...
          >
            ...
            {/* <div className='inline-block h-full bg-[#2C2C2C]' onClick={e => e.stopPropagation()}> */}
            <div className='inline-block h-full bg-[#FFFFFF]' onClick={e => e.stopPropagation()}>
