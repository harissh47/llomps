...
const ConfigPanel = () => {
  ...
  console.log("config panel vandhuduchu over")
  ...
  return (
    <div className='flex flex-col max-h-[80%] w-full max-w-[720px]'>
      <div
        ...
        // `}
        // className={`
        //   grow rounded-xl overflow-y-auto bg-[#2c2c2c]
        //   ${showConfigPanelBeforeChat && 'border-[0.5px] border-gray-700 shadow-lg'}
        //   ${!showConfigPanelBeforeChat && collapsed && 'border border-gray-700'}
        //   ${!showConfigPanelBeforeChat && !collapsed && 'border-[0.5px] border-gray-700 shadow-lg'}
        //   `}
        className={`
          grow rounded-xl overflow-y-auto
              ...
              <>
                ...
                </div>
                {
                  appData?.site.description && (
                    ...
                    // <div className='mt-2 w-full text-base text-gray-100'>
                    <div className='mt-2 w-full text-sm text-gray-500'>
                      {appData?.site.description}
                    </div>
                  )
          ...
          showConfigPanelBeforeChat && (
            <div className='p-6 rounded-b-xl'>
              ...
              <Button
                ...
                // className={`px-4 py-0 h-9 bg-[#bed730] hover:bg-[#bed730]/80 ${inputsForms.length && !isMobile && 'ml-[136px]'}`}
                className={'px-4 py-0 h-9 bg-[#bed730] hover:bg-[#bed730]/80'}
                type='primary'
      ...
      </div>
      {
        showConfigPanelBeforeChat && (site || customConfig) && (
          <div className='mt-4 flex flex-wrap justify-between items-center py-2 text-xs text-gray-400'>
            {site?.privacy_policy
              ? <div className={`flex items-center ${isMobile && 'w-full justify-end'}`}>{'Please read the '}
                <a
